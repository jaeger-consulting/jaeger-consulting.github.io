...
# Last modified by: Jonathan Jaeger - Date: 2020-10-27                                                                     #
#--------------------------------------------------------------------------------------------------------------------------#
...
#--------------------------------------- Sample size for target power in 1:1 ratio ----------------------------------------#
   ...
   #-------------------------------------------- Setting up parallel computing --------------------------------------------#
      ...
      clusterExport(cl = cl,
                    varlist = c('model_stan', 'superiority_threshold', 'power_target', 'iter', 'warmup'))
      clusterEvalQ(cl = cl,
...
#------------------------------------------ Saving image of all the simulations -------------------------------------------#
   ...
   save.image('G:/03_Projects/001_Website/jaeger-consulting.github.io/documents/allocation_ratio_prior_information.RData')
